...
#define SET_LED_NET         DT = 0
#define CLEAR_LED_NET       DT = 1
#define SET_LED_ERROR       K1 = 0
#define CLEAR_LED_ERROR     K1 = 1
#define CLEAR_LED_MODE      {K2 = 1; K3 = 1; K4 = 1;}
#define SET_LED_STANDBY     {K2 = 0; K3 = 1; K4 = 1;}
#define SET_LED_AUTO        {K2 = 1;\
                             if (power_board_version >= 110) {K3 = 1; K4 = 0;}\
                             else {K3 = 0; K4 = 1;}\
                            }
#define SET_LED_FIXED       {K2 = 1;\
                             if (power_board_version >= 110) {K3 = 0; K4 = 1;}\
                             else {K3 = 1; K4 = 0;}\
                            }
// #define SET_LED_AUTO_FIXED  {KO2 = 1; KO3 = 0; KO4 = 0;}
#define SET_LED_ALL         {K1 = 0; K2 = 0; K3 = 0; K4 = 0; DT = 0;}
#define CLEAR_LED_ALL       {K1 = 1; K2 = 1; K3 = 1; K4 = 1; DT = 1;}
