...
@near uchar stop_dly_cnt;

@near uchar autorun_delay_sec;


@near ulong bias_arr[QSIZE] = {0};
@near uchar bias_idx = 0;
@near uchar bias_arr_is_full = 0;
@near uchar user_speed_inc = 0;
@near ulong bias;
...
@near tutorial_state_t tutorial_state;
