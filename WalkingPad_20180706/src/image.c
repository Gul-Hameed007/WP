 ...
 *-----------------------------------------------------*/
@near uchar image[LED_IMAGE_SIZE];
@near uchar* const images[] = {image, image + LED_UP_SIZE};
@near const uchar led_sizes[] = {LED_UP_SIZE, LED_DOWN_SIZE};

uchar const ascii_2[][5] = //
    {
