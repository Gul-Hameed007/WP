  ...
  34                     ; 11 @far @interrupt void NonHandledInterrupt (void)
  34                     ; 12 {
  35                     	switch	.text
  ...
  84  0024 82            	dc.b	130
  86  0025 00            	dc.b	page(f_rc_isr)
  87  0026 0000          	dc.w	f_rc_isr
  88  0028 82            	dc.b	130
 ...
 102  0035 00            	dc.b	page(f_TIM1_OV_isr)
 103  0036 0000          	dc.w	f_TIM1_OV_isr
 ...
 110  003d 00            	dc.b	page(f_TIM2_OV_isr)
 111  003e 0000          	dc.w	f_TIM2_OV_isr
 ...
 138  0059 00            	dc.b	page(f_txd_isr)
 139  005a 0000          	dc.w	f_txd_isr
 140  005c 82            	dc.b	130
 142  005d 00            	dc.b	page(f_rxd_isr)
 143  005e 0000          	dc.w	f_rxd_isr
 ...
 150  0065 00            	dc.b	page(f_TIM4_isr)
 151  0066 0000          	dc.w	f_TIM4_isr
 ...
 229                     	xref	f_rxd_isr
 230                     	xref	f_TIM4_isr
 231                     	xref	f_TIM2_OV_isr
 232                     	xref	f_TIM1_OV_isr
 233                     	xref	__stext
 234                     	xdef	f_NonHandledInterrupt
 253                     	end
